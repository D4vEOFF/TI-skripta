\begin{tikzpicture}[
    ...
    \node[seed] (sa) at (-5.2,1.85) {tajný seed \(s\)};
    \node[seed] (sb) at (5.2,1.85) {tajný seed \(s\)};
    \node[box] (ga) at (-1.8,1.85) {\(G(s)\)};
    \node[box] (gb) at (1.8,1.85) {\(G(s)\)};
    \node[box] (enc) at (-1.8,-.25) {\(c=m\oplus G(s)\)};
    \node[box] (dec) at (1.8,-.25) {\(m=c\oplus G(s)\)};
