...
\begin{remark}
    Za jeden z~prvních překladačů se považuje systém A-0,~který vytvořila Grace Hopperová na začátku 50.~let. Významným dalším krokem byl překladač jazyka FORTRAN vedený Johnem Backusem a~uvedený roku 1957; ukázal,~že program ve vyšším jazyce lze převést na dostatečně účinný strojový kód.
\end{remark}

\begin{figure}[h]
    \centering
    \input{04-kompilatory/images/ch04_preklad.tex}
...
\begin{figure}[h]
    \centering
    \input{04-kompilatory/images/ch04_retezec-c.tex}
...
\paragraph{Strojový kód a~mezikód.}
...
\begin{figure}[h]
    \centering
    \input{04-kompilatory/images/ch04_faze.tex}
