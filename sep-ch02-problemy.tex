...
\begin{center}
    {\huge \textbf{\MakeUppercase{Algoritmicky těžké problémy}}}\\[1.2cm]
\end{center}
...
Nás budou zajímat ty nejdůležitější problémy z~této oblasti,~protože mezi nimi lze nalézt zajímavé vztahy,~a~posléze si uděláme menší ochutnávku z~problematiky \ensuremath{\classP} a~\ensuremath{\classNP}.

\input{02-problemy/sections/s01-obecny-sat}
\input{02-problemy/sections/s02-sat}
\input{02-problemy/sections/s03-3sat.tex}
\input{02-problemy/sections/s04-nzmna.tex}
\input{02-problemy/sections/s05-klika.tex}
\input{02-problemy/sections/s06-p-np.tex}
