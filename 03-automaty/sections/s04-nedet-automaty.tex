...
\begin{remark}
    Deterministické a~nedeterministické konečné automaty systematicky popsali Michael O.~Rabin a~Dana Scott. Za článek z~roku 1959 a~navazující práci o~konečných automatech obdrželi v~roce 1976 Turingovu cenu. Jejich výsledek ukázal,~že nedeterminismus zápis zkracuje,~ale u~konečných automatů nezvětšuje výpočetní sílu.
\end{remark}
...
\begin{definition}[Nedeterministický konečný automat]
    ...
    \[\mapping{\delta}{Q\times\Sigma}{\powset(Q)}\]
...
\begin{example}[Slova obsahující podslovo $101$]\label{ex:nfa-101}
    ...
    \begin{figure}[h]
        \centering
        \input{03-automaty/images/ch03_nfa-podslovo-101.tex}
...
\begin{example}[Třetí znak od konce je $1$]\label{ex:nfa-treti-od-konce}
    ...
    \begin{figure}[h]
        \centering
        \input{03-automaty/images/ch03_nfa-treti-od-konce.tex}
...
\begin{example}[Jednoduchý zápis desetinného čísla]
    ...
    \begin{figure}[h]
        \centering
        \input{03-automaty/images/ch03_automat-desetinne.tex}
...
\begin{definition}[$\lambda$-NFA]
    ...
    \[
        \mapping{\delta}{Q\times(\Sigma\cup\set{\lambda})}{\powset(Q)},
    \]
...
\begin{figure}[h]
    \centering
    \input{03-automaty/images/ch03_dukaz-neq.tex}
