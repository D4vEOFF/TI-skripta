...
Ekvivalentně můžeme les definovat jako \emph{sjednocení stromů}. Jako poslední si uveďme speciální typ stromu,~se kterým budeme dále nejčastěji pracovat,~a~to tzv. \emph{binární strom}. Blíže se s~ním setkáme v~sekci \ref{sec:halda},~kdy budeme rozebírat tzv. \emph{binární haldu}.
