...
\begin{figure}[ht]
    \centering
    \input{07-ai/images/ch07-agent-prostredi.tex}
...
\begin{figure}[ht]
    \centering
    \input{07-ai/images/ch07-data-model-rozhodnuti.tex}
...
\begin{remark}
    Alan Turing formuloval svůj napodobovací test v~článku z~roku 1950. Samotné označení \emph{artificial intelligence} navrhl John McCarthy pro letní seminář v~Dartmouthu roku 1956; tato událost se obvykle považuje za symbolický počátek umělé inteligence jako samostatného oboru.
\end{remark}
